...
6. Make sure you have activated statistics collection (see paragraph 4) otherwise you will not be able to set up your servers instantly.
For instant set up of a registered server without the automatic setup, run the following commands for all servers:
    ```
    # rhn_check	
