...
:::info Changelog
Version 1.1
1. Added `Provides public_cp_vendors_api = 1.1` to rpm spec (see [versioning](/control_panel_integration/#versioning section)).
